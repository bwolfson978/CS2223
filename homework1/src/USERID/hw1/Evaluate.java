...
public class Evaluate {
	public static void main(String[] args) {
		...
		//account for pi and e Math.PI and Math.E
		
		while (!StdIn.isEmpty()) {
			// Read token. push if operator or numerical constant
			String s= StdIn.readString();
			if (s.equals ("(")) { /* do nothing */ }
			else if (s.equals ("pi")) { vals.push(Double.valueOf(Math.PI));}
										//System.out.println(vals.push(Double.valueOf(Math.PI)));
			else if (s.equals ("e")) { vals.push(Double.valueOf(Math.E));}
										//System.out.println(vals.push(Double.valueOf(Math.E)));
